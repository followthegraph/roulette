(() => {
  if (window.__rollsScraperStarted) {
    console.log("Roll scraper already running; skipping duplicate injection.");
  } else {
    window.__rollsScraperStarted = true;
  
    // existing scraper code goes here
